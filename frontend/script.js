...
const modelpath = "https://beatboxai.s3.ap-south-1.amazonaws.com/model.json";
// Drum kit 
const DRUM_CLASSES = [
   'Kick',
   'Snare',
...
const MAX_REC_DURATION = 7.0; // total recording length in seconds
...
function onMicError(){
   alert("Failed to initialize microphone. Allow your browser to access the microphone!")
}
...
function draw(){
   ...
   if (!mic.enabled) mic.start(); // make sure that the mic is on
